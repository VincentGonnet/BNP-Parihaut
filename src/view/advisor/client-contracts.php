<form class="contract-list-form" id="contract-page" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    if (isset($_SESSION['currentClient'])) {
        ...
        <?php elseif (!$allChecked): ?>
            <h4>Attention vous ne possédez pas toutes les pièces justificatives requises. Certaines actions sont par conséquent
                bloquées.</h4>
        <?php endif; ?>
    ...
    <form class="contract-details-page" id="contract-page" style="display: none;"
        ...
        if (isset($_SESSION['currentClient'])) {
            ...
            <div name="contract-list" id="contract-list">
                ...
                <p>
                    ...
                    <input id="openning-date" name="openning-date" type="text"
                        value="<?php echo isset($selectedContract) ? $selectedContract->DATEOUVERTURECONTRAT : ''; ?>" readonly>
                </p>
                ...
                <p>
                    ...
                    <input id="price" name="price" type="text"
                        value="<?php echo isset($selectedContract) ? $selectedContract->TARIFMENSUEL : ''; ?>" readonly>
                </p>
            ...
            <div id="new-contract-section">
                ...
                <p>
                    ...
                    <select id="new-contract-type" name="new-contract-type"
                        style="width:45%;background:#e8d2d2;padding: 6px 1% 6px 1%;margin-top:2px;">
                        <?php foreach ($selectableContracts as $contractOption): ?>
                            <option value="<?= $contractOption->NOMCONTRAT ?>">
                                <?= $contractOption->NOMCONTRAT ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                </p>
                ...
                <p>
                    ...
                    <input class="input" id="new-opening-date" placeHolder="aaaa-mm-jj" name="new-opening-date" value=""
                        type="text" style="margin-top:2px;">
                </p>

                <p>
                    <label class="label" for="new-closing-date">Date de fermeture:</label>
                    <input class="input" id="new-closing-date" placeHolder="aaaa-mm-jj" name="new-ending-date" value=""
                        type="text" style="margin-top:2px;">
                </p>

                <p>
                    <label class="label" for="new-price">Tarifs mensuel:</label>
                    <input class="input" id="new-price" name="new-price" placeHolder="000.00" type="text"
