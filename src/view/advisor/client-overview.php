...
<?php
    ...
    <div>
        ...
        <p>
            ...
            <input  name="input-adress" class="read" for="adress" type="text" value="<?= $adress ?>" readOnly>
        </p>
    ...
    <div>
        <p> 
            ...
            <input  name="input-mail" class="read" for="mail" type="text" value="<?= $mail ?>" readOnly>
        </p> 

        <p>
            <label id="phone">Numéro de telephone:</label>
            <input name="input-phone-number" class="read" for="phone" type="text" value="<?= $phoneNumber?>" readOnly>
        </p>

        <p>
            <label id="situation">Situation familiale:</label>
            <input name="input-situation" class="read" for="situation" type="text" value="<?= $situation?>" readOnly>
        </p>


        <p>
            <label id="work">Profession:</label>
            <input name="input-work" for="work" class="read" type="text" value="<?= $work ?>" readOnly>
        </p>
</div>
