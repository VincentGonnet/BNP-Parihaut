    ...
    <?php 
        ...
        if (isset($_SESSION['currentClient'])) { 
            ...
            foreach ($contracts as $contract) {
                ...
                echo '<button class="button" type="button"style="margin-left:20%;" onclick="switchForms(\'' . $optionValue . '\', \'' . $contract->DATEOUVERTURECONTRAT . '\', \'' . ($contract->DATEFERMETURE ? $contract->DATEFERMETURE : 'Indéterminée') . '\', \'' . $contract->TARIFMENSUEL . '\')">
