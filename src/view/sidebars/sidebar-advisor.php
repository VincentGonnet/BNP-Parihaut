<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">      
    <button name="advisor-planning" value="advisor-planning"> 
    ...
    <button name="advisor-client-documents" value="advisor-client-documents">
    ...
    <button name="advisor-client-overview" value="advisor-client-overview">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <button name="advisor-client-accounts" value="advisor-client-accounts">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <button name="advisor-client-contracts" value="advisor-client-contracts">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <button name="advisor-client-appointments" value="advisor-client-appointments">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
