<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
    <button name="redirect-agent-search-client" value="redirect-agent-search-client">
    ...
    <button name="redirect-agent-new-client" value="redirect-agent-new-client">
    ...
    <?php if (isset($_SESSION['currentClient'])): ?>
        ...
        <button name="redirect-agent-client-overview" value="redirect-agent-client-overview">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd"
        ...
        <button name="redirect-agent-client-accounts" value="redirect-agent-client-accounts">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd"
        ...
        <button name="redirect-agent-client-contracts" value="redirect-agent-client-contracts">
        ...
        <button name="redirect-agent-client-appointments" value="redirect-agent-client-appointments">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path
