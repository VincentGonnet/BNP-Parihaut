...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <button name="agent-client-overview" value="agent-client-overview">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <button name="agent-client-accounts" value="agent-client-accounts">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <button name="agent-client-contracts" value="agent-client-contracts">
    ...
    <button name="agent-client-appointments" value="agent-client-appointments">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
