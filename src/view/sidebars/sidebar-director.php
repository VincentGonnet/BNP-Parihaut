<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
    <button name="redirect-director-manage-employees" value="redirect-director-manage-employees">
    ...
    <button name="redirect-director-add-employee" value="redirect-director-add-employee">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            <path
    ...
    <button name="redirect-director-manage-account-types" value="redirect-director-manage-account-types">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <button name="redirect-director-manage-contract-types" value="redirect-director-manage-contract-types">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd"
    ...
    <button name="redirect-director-manage-documents" value="redirect-director-manage-documents">
    ...
    <button name="redirect-director-see-stats" value="redirect-director-see-stats">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            <path
    ...
    <button name="my-infos" value="my-infos">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
        </svg>
        <?= $_SESSION['loggedInUser']->PRENOM . ' ' . mb_strtoupper($_SESSION['loggedInUser']->NOM) ?>
    </button>
