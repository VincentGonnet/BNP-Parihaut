<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
    <button name="director-manage-employees" value="director-manage-employees"> 
    ...
    <button name="director-add-employee" value="director-add-employee">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <button name="director-manage-account-types" value="director-manage-account-types">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <button name="director-manage-contract-types" value="director-manage-contract-types">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <button name="director-see-stats" value="director-see-stats">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
...
<!-- <script>
    function moveNav() {
        ...
        var accueil = document.getElementById("menu");
        var menuText = document.getElementById("menuText");
    
        if (divContent.style.transform === "scale(1)") {
            sidebar.style.width = "0%";
            sidebar.style.height = "0%";
            divContent.style.transform = "scale(0)";
            menuText.innerText = "Menu"; 
            accueil.style.width="120px";

        } else {
            sidebar.style.width = "19.7%";
            sidebar.style.height = "99%";
            divContent.style.transform = "scale(1)";
            menuText.innerText = "Accueil";
            accueil.style.width="";
